...
{
  "\"end of file\"", "error", "\"invalid token\"", "BROJ", "';'", "'+'",
  "'*'", "'('", "')'", "$accept", "program", "naredba", "e", "t", "f", YY_NULLPTR
};
